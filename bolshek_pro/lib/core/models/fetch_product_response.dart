...
//   String? deliveryType;
//   List<Images>? images;
//   List<Null>? compatibleVehicleIds;
//   String? brandId;
//   String? categoryId;
...
//       compatibleVehicleIds = <Null>[];
//       json['compatibleVehicleIds'].forEach((v) {
//         compatibleVehicleIds!.add(new Null.fromJson(v));
//       });
//     }
...
//       data['compatibleVehicleIds'] =
//           this.compatibleVehicleIds!.map((v) => v.toJson()).toList();
//     }
